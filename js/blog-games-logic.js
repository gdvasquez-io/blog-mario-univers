...
const BE = () => {
  ...
  Yl = {
    easy: { label: "Easy", emoji: "🍄", accent: "bg-red-500", hitScale: 1.3, ringSize: 62, reward: 30, count: 5 },
    medium: { label: "Medium", emoji: "🪙", accent: "bg-yellow-500", hitScale: 1.05, ringSize: 52, reward: 50, count: 5 },
    hard: { label: "Hard", emoji: "⭐", accent: "bg-orange-500", hitScale: 0.9, ringSize: 44, reward: 100, unlockCost: 100, count: 5 },
    impossible: { label: "Impossible", emoji: "💀", accent: "bg-purple-600", hitScale: 0.75, ringSize: 38, reward: 200, unlockCost: 200, count: 5 },
  },
  XE = {
    easy: {
      original: UE,
  ...
  qE = () => {
    const [pts, setPts] = w.useState(() => zE()),
      [unlocked, setUnlocked] = w.useState(() => {
        try { return JSON.parse(localStorage.getItem("diff_unlocked") || '["easy", "medium"]'); } catch { return ["easy", "medium"]; }
      }),
      [e, t] = w.useState(null),
      [n, r] = w.useState([]),
      [o, s] = w.useState([]),
    ...
    w.useEffect(() => {
      localStorage.setItem("diff_unlocked", JSON.stringify(unlocked));
    }, [unlocked]);
    w.useEffect(() => {
      if (a && e) {
        setPts(p => {
          const np = p + (Yl[e].reward || 0);
          localStorage.setItem("sopa_points", String(np));
          return np;
        });
      }
    }, [a, e]);
    return !e ? g.jsxs("div", {
                          ...
                          children: [
                            ...
                            g.jsxs("div", {
                              children: [
                                ...
                                g.jsxs("p", { className: "text-xs text-[#5a2a00]/70 font-bold mt-1", children: ["5 differences"] }),
                              ]
                            })
                          ]
                        }),
          ...
          children: [
            ...
            a && g.jsxs("div", {
              ...
              children: [g.jsx(Um, { className: "w-4 h-4" }), " EXCELLENT! YOU FOUND ALL 5."]
            }),
            g.jsxs("div", {
          ...
          children: [
            g.jsxs("figure", {
              children: [
                g.jsx("div", {
                  className:
                    "relative aspect-video rounded-2xl overflow-hidden border-4 border-foreground/80 shadow-[0_8px_0_hsl(var(--foreground))]",
                  children: g.jsx("img", {
                    src: i.original,
            ...
            g.jsxs("figure", {
              children: [
                g.jsxs("div", {
                  className:
                    "relative aspect-video rounded-2xl overflow-hidden border-4 border-foreground/80 shadow-[0_8px_0_hsl(var(--foreground))] cursor-crosshair transition-all hover:brightness-105",
                  onClick: d,
                  children: [
                    g.jsx("img", {
                      src: i.modified,
                      ...
                      loading: "lazy",
                      className:
                        "block h-full w-full object-cover select-none pointer-events-none",
                      draggable: !1,
                    }),
                    n.map((c) => {
  ...
  Kl = [
    { name: "champinon", src: "./iconos/champinon.png" },
    { name: "girasol", src: "./iconos/flor.png" },
    { name: "estrella", src: "./iconos/estrella.png" },
    { name: "moneda", src: "./iconos/moneda.png" },
    { name: "huevo", src: "./iconos/huevo.png" },
    { name: "cuadrado", src: "./iconos/cuadrado.png" },
    { name: "hoja", src: "./iconos/planta.png" },
  ],
...
const cn = (e) => new Promise((t) => setTimeout(t, e)),
  tb = () => {
    const [pts, setPts] = w.useState(() => zE()),
      [unlocked, setUnlocked] = w.useState(() => {
        try { return JSON.parse(localStorage.getItem("crush_unlocked") || '["easy", "medium"]'); } catch { return ["easy", "medium"]; }
      }),
      [e, t] = w.useState(null),
      n = e ? xr[e] : xr.easy,
      ...
      [y, x] = w.useState(null),
      m = w.useRef(null),
      p = n.goalCount * n.goals,
      v = l.reduce((O, L) => O + Math.min(u[L] ?? 0, n.goalCount), 0),
    ...
    w.useEffect(() => {
      localStorage.setItem("crush_unlocked", JSON.stringify(unlocked));
    }, [unlocked]);
    w.useEffect(() => {
      if (e) b(e);
    }, [e, b]);
      ...
      P = w.useCallback(
        async (O, L, C, $) => {
          ...
          if (W.special === "rainbow" || H.special === "rainbow") {
            ...
            (o(tt(N)), await cn(280), await k(N), i((_) => _ - 1), S(!1));
            return;
          }
          ...
          if (T.length > 0) {
            ...
            for (const D of R) {
              const [_, F] = D.split(",").map(Number);
              N[_][F] = { id: -1, type: -1, special: "normal" };
            }
            for (let D = 0; D < oe; D++) {
              let _ = oe - 1;
              for (let F = oe - 1; F >= 0; F--)
                N[F][D].type !== -1 &&
                  (_ !== F &&
                    ((N[_][D] = N[F][D]),
                    (N[F][D] = { id: -1, type: -1, special: "normal" })),
                  _--);
              for (let F = _; F >= 0; F--)
                N[F][D] = Gl(Math.floor(Math.random() * n.types));
            }
            (o(tt(N)), await cn(260));
          }
          (await k(N), i((R) => R - 1), S(!1));
        },
        [r, f, n.types, y, k],
      ),
    ...
    w.useEffect(() => {
      ...
      l.every((L) => (u[L] ?? 0) >= n.goalCount)
        ? x({ won: !0, pct: 100 })
        : s <= 0 && x({ won: !1, pct: E });
    }, [s, u, l, n.goalCount, y, f, E]);
    const B = s <= 5;
    return !e ? g.jsxs("div", {
          className: "relative mario-panel p-5 md:p-8 overflow-hidden my-10 max-w-5xl mx-auto",
          children: [
                ...
                g.jsxs("div", {
                  ...
                  children: [
                    ...
                    g.jsx("ul", {
                      className: "space-y-2",
                      children: l.map((O) => {
                        const L = Math.min(u[O] ?? 0, n.goalCount),
                          C = L >= n.goalCount;
                        return g.jsxs(
                          "li",
                          {
              ...
              children: g.jsxs("div", {
                ...
                children: [
                  ...
                  g.jsx("p", {
                    ...
                    children:
                      "Adventures through the Mushroom Kingdom — characters, worlds, opinions and fun activities, all in one place.",
                  }),
                ],
              }),
            }),
          ...
          children: [
            ...
            g.jsxs($s, {
              ...
              children: [
                g.jsx("p", {
                  children:
                    "In our opinion, the Super Mario universe has many great characters, but we think Shy Guy, Yoshi, and Luigi are the best. Every character is special and good for different players.",
                }),
                g.jsx("p", {
                  children:
                ...
                g.jsx("p", {
                  children:
                    "Second, Marc likes Yoshi. Yoshi is a very loyal dinosaur and a great friend of Mario. He can run fast, jump high, and eat enemies. We think he is the cutest character in the games.",
                }),
                g.jsx("p", {
                  children:
                ...
                g.jsx("p", {
                  children:
                    "In conclusion, all characters are amazing. But for us, Shy Guy, Yoshi, and Luigi make the games perfect. What is your favorite character?",
                }),
                g.jsx("div", {
                  className: "grid grid-cols-1 md:grid-cols-3 gap-5 pt-2",
                  children: Xl.map((e) => g.jsx(xf, { studentName: e }, e)),
                }),
              ],
            }),
            g.jsxs($s, {
              ...
              children: [
                ...
                g.jsx("p", {
                  children:
                    "First, Daniel loves Super Mario Odyssey. This game is for the Nintendo Switch, and it is beautiful. In this adventure, Mario has a special hat called Cappy. With this hat, Mario can control enemies like Goombas or a big T-Rex. Daniel thinks the open worlds are amazing and very fun to explore.",
                }),
                g.jsx("p", {
                  children:
                    "Second, Marc prefers Mario Kart 8 Deluxe. This is the best racing game for him. It has many tracks, fast cars, and excellent music. Marc likes to choose Yoshi and race against people online. It is a perfect game to play with friends at home because it is very exciting and competitive.",
                }),
                g.jsx("p", {
                  children:
                    "Finally, Josep chooses Super Mario Galaxy. This game is an absolute classic for the Nintendo Wii. In this game, Mario travels to outer space and visits different planets. Josep loves the gravity mechanics because Mario can walk upside down. Also, the orchestral music of this game is beautiful and perfect.",
                }),
                g.jsx("p", {
                  children:
                ...
                g.jsx("div", {
                  className: "grid grid-cols-1 md:grid-cols-3 gap-5 pt-2",
                  children: Xl.map((e) =>
                    g.jsx(xf, { studentName: e, caption: `World by ${e}` }, e),
                  ),
                }),
              ],
            }),
          ...
          children: g.jsxs("div", {
            ...
            children: [
              ...
              g.jsxs("p", {
                className: "mt-1",
                children: [
                  "A school project by three Mario fans · © ",
...
window.llancarLaserEstrella = function(posicioEstrella, tipusIconaAEliminar) {
  ...
  iconesCoincidents.forEach(icona => {
